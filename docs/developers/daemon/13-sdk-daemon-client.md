...
| Sessions       | `createOrAttachSession`、`loadSession`、`resumeSession`、`listWorkspaceSessions`、`closeSession`、`updateSessionMetadata`、`sessionContext`、`sessionContextUsage`、`sessionSupportedCommands`、`sessionTasks`、`sessionStats`、`setSessionApprovalMode`、`setSessionModel`、`detachAll`、`deleteSessionsData`              |
